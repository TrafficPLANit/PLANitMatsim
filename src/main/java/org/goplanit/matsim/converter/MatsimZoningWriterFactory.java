...
class MatsimZoningWriterFactory {
   ...
   */
  static MatsimZoningWriter create(MatsimNetworkWriterSettings networkWriterSettings, MacroscopicNetwork referenceNetwork) {
    return create(
   ...
   */
  static MatsimZoningWriter create(MatsimZoningWriterSettings zoningWriterSettings, MatsimNetworkWriterSettings networkWriterSettings) {
